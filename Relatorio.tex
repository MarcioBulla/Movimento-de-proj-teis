...
\end{tcolorbox}
    ...
    \hypertarget{definindo-parametros-para-plotar-os-gruxe1ficos-de-forma-mais-atraente}{%
\subsubsection*{Definindo parametros para plotar os gráficos de forma
mais
atraente:}\label{definindo-parametros-para-plotar-os-gruxe1ficos-de-forma-mais-atraente}}
...
\end{tcolorbox}
    ...
    \hypertarget{plotando-gruxe1ficos-dos-comportamentos-horizontais-em-funuxe7uxe3o-do-tempo}{%
\paragraph{Plotando gráficos dos comportamentos horizontais em função do
tempo:}\label{plotando-gruxe1ficos-dos-comportamentos-horizontais-em-funuxe7uxe3o-do-tempo}}
...
\end{tcolorbox}
    ...
    \hypertarget{fazendo-soluuxe7uxf5es-para-varios-theta-igual-o-que-foi-feito-no-gruxe1fico-anterior-poruxe9m-com-mais-pontos}{%
\paragraph{\texorpdfstring{Fazendo soluções para varios \(\theta\) igual
o que foi feito no gráfico anterior, porém com mais
pontos:}{Fazendo soluções para varios \textbackslash{}theta igual o que foi feito no gráfico anterior, porém com mais pontos:}}\label{fazendo-soluuxe7uxf5es-para-varios-theta-igual-o-que-foi-feito-no-gruxe1fico-anterior-poruxe9m-com-mais-pontos}}
...
\end{tcolorbox}
    ...
    \hypertarget{plotando-gruxe1fico-da-altura-e-alcance-maximo-em-funuxe7uxe3o-do-angulo}{%
\paragraph{Plotando gráfico da altura e alcance maximo em função do
angulo:}\label{plotando-gruxe1fico-da-altura-e-alcance-maximo-em-funuxe7uxe3o-do-angulo}}
...
velocidade inicial esta em \(z\). Além disto, como vimos no gráfico
anterior o alcance maximo esta próximo de 25°.

\hypertarget{fazendo-o-mesmo-que-o-anterior-poruxe9m-com-c-variando-no-loop}{%
\paragraph{\texorpdfstring{Fazendo o mesmo que o anterior, porém com
\(c\) variando no
\emph{loop}:}{Fazendo o mesmo que o anterior, porém com c variando no loop:}}\label{fazendo-o-mesmo-que-o-anterior-poruxe9m-com-c-variando-no-loop}}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{12}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Criando array para recolher os pontos}
\PY{n}{pontos} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{p}{]}\PY{p}{]}\PY{p}{)}

\PY{c+c1}{\PYZsh{} Aumentando o periodo de tempo, pois para pequenos valores de c opercurso será maior}
\PY{n}{t} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{300}\PY{p}{,} \PY{k+kc}{True}\PY{p}{)}

\PY{k}{for} \PY{n}{\PYZus{}} \PY{o+ow}{in} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{,} \PY{k+kc}{True}\PY{p}{)}\PY{p}{:}  \PY{c+c1}{\PYZsh{} loop variando \PYZdl{}\PYZbs{}theta\PYZdl{}}
    \PY{c+c1}{\PYZsh{} pegando o valor da constante para cada loop}
    \PY{n}{c} \PY{o}{=} \PY{n}{\PYZus{}}
    \PY{c+c1}{\PYZsh{} Solução do eixos x e z}
    \PY{n}{sol\PYZus{}i} \PY{o}{=} \PY{n}{solve\PYZus{}ivp}\PY{p}{(}\PY{n}{fun}\PY{o}{=}\PY{n}{r}\PY{p}{,} \PY{n}{t\PYZus{}span}\PY{o}{=}\PY{p}{[}\PY{n}{t}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{t}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{n}{y0}\PY{o}{=}\PY{p}{[}\PY{n}{x0}\PY{p}{,} \PY{n}{z0}\PY{p}{,} \PY{n}{vx0}\PY{p}{,} \PY{n}{vz0}\PY{p}{]}\PY{p}{,} \PY{n}{method}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{LSODA}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{t\PYZus{}eval}\PY{o}{=}\PY{n}{t}\PY{p}{,} \PY{n}{args}\PY{o}{=}\PY{p}{(}\PY{n}{g}\PY{p}{,} \PY{n}{c}\PY{p}{,} \PY{n}{m}\PY{p}{)}\PY{p}{,} \PY{n}{events}\PY{o}{=}\PY{p}{(}\PY{n}{topo}\PY{p}{,} \PY{n}{alcance}\PY{p}{)}\PY{p}{,} \PY{n}{dense\PYZus{}output}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} Recolhendo somente os pontos de interesse gerados pela soção}
    \PY{n}{pontos} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{pontos}\PY{p}{,} \PY{p}{[}\PY{p}{[}\PY{n}{\PYZus{}}\PY{p}{]}\PY{p}{,} \PY{n}{sol\PYZus{}i}\PY{o}{.}\PY{n}{y\PYZus{}events}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{sol\PYZus{}i}\PY{o}{.}\PY{n}{y\PYZus{}events}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \hypertarget{plotando-gruxe1fico-da-altura-e-alcance-muxe1ximo-em-funuxe7uxe3o-do-fator-de-resistuxeancia-do-ar}{%
\paragraph{Plotando gráfico da altura e alcance máximo em função do
fator de resistência do
ar:}\label{plotando-gruxe1fico-da-altura-e-alcance-muxe1ximo-em-funuxe7uxe3o-do-fator-de-resistuxeancia-do-ar}}
...
\PY{n}{ax1}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{c}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{r}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax1}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Altura máxima em função de \PYZdl{}c\PYZdl{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax1}\PY{o}{.}\PY{n}{set\PYZus{}ylim}\PY{p}{(}\PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{.}\PY{n}{min}\PY{p}{(}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{ax1}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Altura máxima (m)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{n}{ax2}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,} \PY{n}{c}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax2}\PY{o}{.}\PY{n}{set\PYZus{}xlim}\PY{p}{(}\PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{o}{.}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{+}\PY{o}{.}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{ax2}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Alcance máxima em função de \PYZdl{}c\PYZdl{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax2}\PY{o}{.}\PY{n}{set\PYZus{}ylim}\PY{p}{(}\PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{.}\PY{n}{min}\PY{p}{(}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{8}\PY{p}{,} \PY{n}{pontos}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{8}\PY{p}{)}
\PY{n}{ax2}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Constante da resistencia do ar (\PYZdl{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{frac}\PY{l+s+si}{\PYZob{}Kg\PYZcb{}}\PY{l+s+si}{\PYZob{}m\PYZcb{}}\PY{l+s+s2}{\PYZdl{})}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax2}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Alcance máximo (m)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Relatorio_files/Relatorio_25_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    Como o esperado ambas tendem a zero, pois, ao aumentar a resistência do
ar o projétil freará cada vez mais rápido. Além disso, observe que o
alcance máximo tende mais rápido que o alcance, pois além da resistência
do ar o projetil está sob a aceleração gravitacional.
...
\end{tcolorbox}
    ...
    \hypertarget{plotando-gruxe1ficos-da-soluuxe7uxe3o-para-velocidade-e-posiuxe7uxe3o-em-funuxe7uxe3o-do-tempo}{%
\paragraph{Plotando gráficos da solução para velocidade e posição em
função do
tempo:}\label{plotando-gruxe1ficos-da-soluuxe7uxe3o-para-velocidade-e-posiuxe7uxe3o-em-funuxe7uxe3o-do-tempo}}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Relatorio_files/Relatorio_37_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\PY{c+c1}{\PYZsh{} arrays para agrupar os pontos, para fazer um auto limite no gráfico}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.legend.Legend at 0x7fd4a5c80eb0>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Relatorio_files/Relatorio_39_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \hypertarget{plotando-gruxe1ficos-da-posiuxe7uxe3o-e-velocidade-horizontal-em-funuxe7uxe3o-do-tempo}{%
\paragraph{Plotando gráficos da posição e velocidade horizontal em
função do
tempo:}\label{plotando-gruxe1ficos-da-posiuxe7uxe3o-e-velocidade-horizontal-em-funuxe7uxe3o-do-tempo}}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Relatorio_files/Relatorio_47_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Relatorio_files/Relatorio_49_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Relatorio_files/Relatorio_52_1.png}
    \end{center}
    { \hspace*{\fill} \\}
